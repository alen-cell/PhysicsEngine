...
public class DrawLines
{
    ...
    public static void DrawVertices(Camera camera,IList<Vector4> vertices,Color color, Matrix4x4 localToWorld,IList<int> indices = null)
    {
        switch (LineMode)
        {
    ...
    public static void DrawVerticesAsLines(Camera  camera,Color color,IList<Vector4> vertices,Matrix4x4 localToWorld, IList<int> indices)
    {
        if (camera == null || vertices == null) return;
