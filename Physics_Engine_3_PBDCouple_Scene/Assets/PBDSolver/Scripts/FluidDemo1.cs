...

{
    ...
    private FluidDemo1() { }
    private static FluidDemo1 _instance = null;
    public static FluidDemo1 Instance
    {
        get
        {
            return _instance;
  ...
  //  [Range(0,0.1f)]
   ...
   // public Bounds bounds;
    ...
    public FluidParticles m_fluid;
    public BoundaryParticles m_boundary;
    ...
    private void CreateBoundary(float radius,float density)
    {
        ...
        ParticleSource source = new ParticleSource(diameter, outerBounds, innerBounds,true);
        ...
        void Update()
    {
        ...
        if (m_run)
        {
            ...
            if (m_drawFluidVolume)
                m_volume.FillVolume(m_fluid, m_solver.Hash, m_solver.smoothingKernel);
// DepthNormalsFeature.FluidCount = m_fluid.NumParticles;
            Profiler.EndSample();
