...
public class BitonicSort : IDisposable
{
   ...
   // public static ComputeBuffer DebugBuffer;
    ...
    public BitonicSort(int count)
    {
       ...
       // DebugBuffer = new ComputeBuffer(NumElements, 2 * sizeof(int));
    ...
    public void Sort(ComputeBuffer input)
    {
       ...
       // m_shader.SetBuffer(m_fillKernel, "Debug", DebugBuffer);
        ...
        for (int level = (BITONIC_BLOCK_SIZE * 2); level <= NumElements; level = level * 2)
        {
           ...
           // m_shader.SetBuffer(m_transposeKernel, "Debug", DebugBuffer);
      ...
      //  m_shader.SetBuffer(m_copyKernel, "Debug", DebugBuffer);
        m_shader.SetInt("Width", count);
